            ...
            window.JSCookie = {
                ...
                get: function (n) {
                    var match = n + "=",
                        ...
                        i;
                    for (i = 0; i < ca.length, c = ca[i]; i++) if (c.indexOf(match) !== -1) return c.substring(match.length, c.length);
                    return null
                },
                del: function (n) {
                    this.set(n, "", -1)
...
(function ($) {
    $(document).ready(function () {
        $(".nav-menu > li:not('.current-menu-item, .current-menu-parent')").click(function (event) {
        ...
        $('.nav-menu li ul').click(function (event) {
            event.stopPropagation();
        });
        // Add fancybox to event images
        $('.attachment-full, .attachment-medium, .attachment-thumbnail, .attachment-history-right').addClass('align-none').parent().addClass('fancybox-img');
        ...
        $('.oral_histories').find('.attachment-history-right').parent().attr('rel', 'o_gallery');
...
jQuery(window).load(function(){
        jQuery("#nivoslider-1359").nivoSlider({
...
(function ( $ ) {
    ...
    $(function () {
        ...
        $("#menu-cjhs-menu li:nth-child(3)").addClass('sub-break');
        $('#menu-cjhs-menu li').hover(
        function(){
